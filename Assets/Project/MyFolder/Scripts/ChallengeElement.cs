...
public class ChallengeElement : MonoBehaviour
{
    ...
    public void SetProps(string no, long userId, string userName, string userScore, string room_amount, string type = "CHALLENGE", string roomId = "")
    {
        //this.no.text = no;
        ...
        this.score_text.text = userScore;
